...
declare global {
  interface Window {
    ...
    // Control globals
    ctrl_omnis_vite_control: any
    ctrl_omnis_vite_control_hooks: any
    ctrl_omnis_vite_control_registry: any
  }
}
...
window.ctrl_omnis_vite_control_registry = new Map()

window.ctrl_omnis_vite_control = function () {
  this.init_class_inst()
}

window.ctrl_omnis_vite_control.prototype = (function () {
  ...
  ctrl.init_ctrl_inst = function (form: any, elem: any, rowCtrl: any, rowNumber: any) {
    ...
    window.ctrl_omnis_vite_control_registry.set(this.controlId, this)
    ...
    // setup and the
    const hooks = window.ctrl_omnis_vite_control_hooks.get(controlId)
    ...
    window.ctrl_omnis_vite_control_hooks.set(controlId, hooks)
